...
for i in range(200):
    ...
    train_out = leaky_RELU(dot(train_in, nn_weights)+bias)
    print("train_out =")
    print(train_out)
    # Run the NN adjustments 
    error = (train_sol-train_out)*leaky_RELU_Derivative(train_out)
